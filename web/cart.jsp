...
<html style="font-size: 16px;">
  <head>
    ...
    <title>cart</title>
    <link rel="stylesheet" href="nicepage_cart.css" media="screen">
<link rel="stylesheet" href="cart.css" media="screen">
    <script class="u-script" type="text/javascript" src="jquery_cart.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="nicepage_cart.js" defer=""></script>
  ...
  <body class="u-body"><header class="u-clearfix u-custom-color-2 u-header u-sticky u-sticky-048c u-header" id="sec-de96"><div class="u-clearfix u-sheet u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-custom-color-1 u-section-1" id="sec-fb9f">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h3 class="u-align-center u-custom-font u-font-montserrat u-text u-text-default u-text-1" data-animation-name="flipIn" data-animation-duration="1000" data-animation-delay="0" data-animation-direction="X">Cart</h3>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-16 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 18px;" redirect="true">
            <input type="hidden" id="siteId" name="siteId" value="94703336">
            <input type="hidden" id="pageId" name="pageId" value="276515964">
        ...
        ps=co.prepareStatement("select * from cart where u_id=?");
        ...
        while(rs.next())
        {
            p_id=rs.getString(2);
            String p_n="";
            ps1=co.prepareStatement("select * from products where p_id=?");
            ps1.setInt(1,Integer.parseInt(p_id));
            ...
            <div class="u-form-checkbox u-form-group u-form-group-1">
              <input type="checkbox" id="checkbox-fd55" name="checkbox" value="On">
              <label for="checkbox-fd55" class="u-custom-font u-font-montserrat u-label u-label-1"><a href="product_show.jsp?id=<%=p_id%>"><%=p_n%></a></label>
            </div>
   <%
          }
            rs1.close();
    ...
    %>
            ...
            <div class="u-align-center u-form-group u-form-submit">
              <a href="#" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-2 u-custom-font u-font-montserrat u-hover-custom-color-3 u-radius-50 u-text-custom-color-1 u-text-hover-custom-color-2 u-btn-1">Delete Product</a>
